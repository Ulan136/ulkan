      ...
      <div style={{ background: '#211f1c', padding: '12px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ color: '#8c857a', fontSize: 12 }}>{user.name}</div>
          </div>
        </div>
        <button onClick={logout} style={{ background: '#322f2b', border: 'none', borderRadius: 7, padding: '6px 12px', color: '#cfc9c0', cursor: 'pointer', fontSize: 13, fontFamily: 'inherit' }}>Выйти</button>
      </div>
